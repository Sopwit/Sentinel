...
Most recent work: Phase 6.5, Memory Taxonomy and Semantic Metadata Skeleton.
...
Keep model/provider routing, catalog, task planning, agent registry, and memory taxonomy
