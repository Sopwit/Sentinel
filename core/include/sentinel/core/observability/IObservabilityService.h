...
public:
    ...
    virtual void setSpanAttribute(const QString& spanId, const QString& key, const QString& value) = 0;

    // Metrics
    virtual void recordMetric(const QString& name, double value, const QMap<QString, QString>& attributes = {}) = 0;
    virtual void incrementCounter(const QString& name, const QMap<QString, QString>& attributes = {}) = 0;

    // Logging
    virtual void logInfo(const QString& message, const QMap<QString, QString>& attributes = {}) = 0;
    virtual void logWarning(const QString& message, const QMap<QString, QString>& attributes = {}) = 0;
    virtual void logError(const QString& message, const QMap<QString, QString>& attributes = {}) = 0;
