...
ModelLifecycleService::ModelLifecycleService() {
    ...
    m_models.append(
        {"gpt-4o-mini", "openai", "GPT-4o Mini", ModelStatus::Active, 128000, 0.00015, 0.0006});
    m_models.append(
        {"gpt-4-turbo", "openai", "GPT-4 Turbo", ModelStatus::Active, 128000, 0.01, 0.03});
    m_models.append({"claude-sonnet-4-20250514", "anthropic", "Claude Sonnet 4",
                     ModelStatus::Active, 200000, 0.003, 0.015});
    m_models.append({"claude-3-5-haiku-20241022", "anthropic", "Claude 3.5 Haiku",
                     ModelStatus::Active, 200000, 0.001, 0.005});
    m_models.append({"gemini-2.5-pro", "google", "Gemini 2.5 Pro", ModelStatus::Active, 1000000,
                     0.00125, 0.005});
}
