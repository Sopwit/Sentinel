...
if(WIN32)
    ...
    set(CPACK_WIX_PRODUCT_GUID "a1b2c3d4-e5f6-7a8b-9c0d-e1f2a3b4c5d6" CACHE STRING "WiX Product GUID")
    set(CPACK_WIX_UPGRADE_GUID "b2c3d4e5-f6a7-0b1c-2d3e-4f5a6b7c8d9e" CACHE STRING "WiX Upgrade GUID")
...
elseif(UNIX AND NOT APPLE)
    ...
    set(CPACK_RPM_PACKAGE_REQUIRES "qt6-qtbase >= 6.5.0, qt6-qtdeclarative >= 6.5.0, qt6-qtsql >= 6.5.0, qt6-qtmultimedia >= 6.5.0, qt6-qtsql-sqlite >= 6.5.0, hicolor-icon-theme")
    ...
    set(CPACK_RPM_EXCLUDE_FROM_AUTO_FILELIST_ADDITION "/usr/share/applications;/usr/share/icons;/usr/share/icons/hicolor;/usr/share/metainfo;/usr/share/dbus-1;/usr/share/dbus-1/services;/usr/lib/systemd;/usr/lib/systemd/user;/etc")
...
elseif(APPLE)
    ...
    if(EXISTS "${CMAKE_SOURCE_DIR}/resources/platform/macos/Info.plist")
        set(CPACK_BUNDLE_PLIST "${CMAKE_SOURCE_DIR}/resources/platform/macos/Info.plist")
    endif()
